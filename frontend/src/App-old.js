    ...
    <div className="App">
      ...
      <nav className="top-navbar">
        <div className="navbar-brand">
          ...
          <span className="brand-text">League Scheduler</span>
        </div>
        
        <div className="navbar-center">
          <button
            className={`nav-competition-btn ${selectedCompetition === 'league' ? 'active' : ''}`}
          ...
          <button
            className={`nav-competition-btn ${selectedCompetition === 'cup' ? 'active' : ''}`}
          ...
          <button
            className={`nav-competition-btn ${selectedCompetition === 'super-cup' ? 'active' : ''}`}
        ...
        <div className="navbar-actions">
          {!isAdmin ? (
            ...
            <>
              <button
                className={`navbar-admin-btn ${activeTab === 'admin' ? 'admin-active' : ''}`}
                onClick={() => setActiveTab(activeTab === 'admin' ? 'user' : 'admin')}
              >
                <span>{activeTab === 'admin' ? '🏆' : '⚙️'}</span>
                <span>{activeTab === 'admin' ? 'View' : 'Admin'}</span>
              </button>
              <button
                className="navbar-admin-btn logout"
      ...
      <div className="container">
        ...
        {/* Main Header Navigation - Admin Access Only */}
